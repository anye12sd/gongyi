...
export default {
  install( Vue ){
    ...
    Vue.prototype.createElement = function () {
      ...
      str+= '<div class="crop_loading"><div class="crop_content"><img src="http://zbbcdn.jihui88.net/loading.gif"><div class="crop_text">图片上传中</div></div></div>';
    ...
    Vue.prototype.postImg = function( imageData ) {
      ...
      let fileImg = this.base64ToBlob(imageData)
      formData.append('file', fileImg, "img.jpg");
      axios.post(`https://api.jihui88.net/gyr99/index.php/gongyijie/image`, formData).then((res) => {
        window.sessionStorage.setItem('pic_url', res.data.url)
      })
      let self = this;
      self.destoried();
    ...
    // 
    Vue.prototype.base64ToBlob = function (urlData) {
